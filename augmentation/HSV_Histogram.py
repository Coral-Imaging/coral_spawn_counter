...
if __name__ == '__main__':
    ...
    plt.subplot(1, 3, 1)
    plt.hist([value[0] for value in Tank_da42.values()], bins=30, alpha=0.5, color='r', label='Tank_da42')
    plt.hist([value[0] for value in Tank_438d.values()], bins=30, alpha=0.5, color='b', label='Tank_438d')
    plt.hist([value[0] for value in Tank_b5af.values()], bins=30, alpha=0.5, color='g', label='Tank_b5af')
    ...
    plt.subplot(1, 3, 2)
    plt.hist([value[1] for value in Tank_da42.values()], bins=30, alpha=0.5, color='r', label='Tank_da42')
    plt.hist([value[1] for value in Tank_438d.values()], bins=30, alpha=0.5, color='b', label='Tank_438d')
    plt.hist([value[1] for value in Tank_b5af.values()], bins=30, alpha=0.5, color='g', label='Tank_b5af')
    ...
    plt.subplot(1, 3, 3)
    plt.hist([value[2] for value in Tank_da42.values()], bins=30, alpha=0.5, color='r', label='Tank_da42')
    plt.hist([value[2] for value in Tank_438d.values()], bins=30, alpha=0.5, color='b', label='Tank_438d')
    plt.hist([value[2] for value in Tank_b5af.values()], bins=30, alpha=0.5, color='g', label='Tank_b5af')    
    plt.xlabel('Value')
    plt.ylabel('Frequency')
